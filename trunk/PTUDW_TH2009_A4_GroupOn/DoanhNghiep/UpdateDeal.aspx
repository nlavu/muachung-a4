...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="LabelThoiGianBatDau" runat="server" 
        Text="Thời gian bắt đầu khuyến mãi"></asp:Label>
            ...
            <td>
    <asp:TextBox ID="TextBoxThoiGianBatDau" runat="server" style="margin-bottom: 0px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style2">
    ...
    <asp:Label ID="LabelGiaKhuyenMai" runat="server" Text="Giá khuyến mãi"></asp:Label>
            ...
            <td>
    <asp:TextBox ID="TextBoxGiaKhuyenMai" runat="server" 
                    ontextchanged="TextBoxGiaKhuyenMai_TextChanged"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style2">
