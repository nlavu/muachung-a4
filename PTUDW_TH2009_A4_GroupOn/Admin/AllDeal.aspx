<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AllDeal.aspx.cs" Inherits="PTUDW_TH2009_A4_GroupOn.Admin.AllDeal" %>
...
-->      
    ...
    <td valign="top"><h1 align="left">Manage Deals</h1>
      ...
      <table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <td width="10%" align="center"  height="30px" ><a href="deals_manage.php?current=1">Current</a></td>
          ...
          <td width="10%" align="center" style=" border-style:ridge; border-color:#3366CC;"><a href="deals_manage.php?all=1">All</a></td>
