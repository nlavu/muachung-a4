...
{
    public partial class LoadDeal : System.Web.UI.Page
    {
        ...
        {
            String result = "";
            int loai = int.Parse(Request.QueryString["id"].ToString());
            if (loai == 3)
            {
                ...
                foreach (LoaiVoucherDTO i_LoaiVoucher in lstLoaiVoucher)
                {
                    ...
                    List<VoucherDTO> lstVoucher = VoucherBUS.SelectAllVoucher();
            ...
            if (loai == 2)
            {
                ...
                foreach (LoaiVoucherDTO i_LoaiVoucher in lstLoaiVoucher)
                {
                    result += @"
                            ...
                            <div class='clear h_15'></div>";
                    int i_maLoai = i_LoaiVoucher.MALOAIVOUCHER1;
                    List<VoucherDTO> lstVoucher = VoucherBUS.SelectTheoMaLoaidangban(i_maLoai);
                    int i_checkPosition = 0;
                    foreach (VoucherDTO i_Vocher in lstVoucher)
                    {
                        float newprice = i_Vocher.GIAKHUYENMAI1;
